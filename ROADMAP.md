...
4. **M3 Content verticals (in progress: lifecycle, taxonomy, media, menus, and SEO complete)** — page/post lifecycle, taxonomy, media security/processing, deterministic navigation, and production SEO are hardened; forms are next; bounded queries, audits and complete CRUD authorization.
