...
2. **M1 Identity and deny-by-default RBAC** — hardened auth/throttling/disabled accounts, verification/reset/confirmation/profile/sessions; normalized users/roles/permissions, safe delegation/system roles, admin UI, policies and authorization matrix; privileged MFA.
