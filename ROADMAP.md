...
4. **M3 Content verticals (in progress: lifecycle, taxonomy, media, and menus complete)** — page/post lifecycle, taxonomy, and media security/processing, and deterministic navigation are hardened; SEO is next, followed by forms; bounded queries, audits and complete CRUD authorization.
