...
3. **M2 Pulse design system and admin shell (in progress: foundation, M1 workflow migration, and legacy module presentation/confirmation bridge complete)** — tokens and reusable accessible components, custom safe toast/dialog/drawer system; responsive admin/public foundations; remove dead UI/assets.
