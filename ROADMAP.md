...
4. **M3 Content verticals (in progress: lifecycle and taxonomy complete)** — page/post lifecycle and taxonomy are hardened; media security/processing is next, followed by menus, SEO and forms; bounded queries, audits and complete CRUD authorization.
