...
2. **M1 Identity and deny-by-default RBAC (in progress)** — hardened auth/throttling/disabled accounts and the normalized RBAC/Gate/route-enforcement foundation are complete; verification/reset/confirmation/profile/sessions, safe delegation/system-role administration UI, expanded authorization matrix and privileged MFA remain.
