...
4. **M3 Content verticals (in progress: lifecycle, taxonomy, and media complete)** — page/post lifecycle, taxonomy, and media security/processing are hardened; menus are next, followed by SEO and forms; bounded queries, audits and complete CRUD authorization.
