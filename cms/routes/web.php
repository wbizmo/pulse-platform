...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::post('/plugins/{plugin}/toggle', [PluginController::class, 'toggle'])
                ->name('plugins.toggle');

            Route::get('/plugins/{plugin}/settings', [PluginSettingsController::class, 'index'])
                ->name('plugins.settings');

            Route::post('/plugins/{plugin}/settings', [PluginSettingsController::class, 'update'])
            ...
            Route::get('/themes/{theme}/settings', [ThemeSettingsController::class, 'index'])
                ->name('themes.settings');

            Route::post('/themes/{theme}/settings', [ThemeSettingsController::class, 'update'])
